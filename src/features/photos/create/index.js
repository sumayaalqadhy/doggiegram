...
// Imported useDispatch and addPhoto from proper places
...
export default function CreatePhoto() {
  ...
  // Stored a reference to the Redux store's dispatch method in a variable called `dispatch`
  ...
  function handleSubmit(event) {
    ...
    // Dispatched the `addPhoto()` action creator, passing in the form data
